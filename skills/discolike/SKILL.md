...
| Narrow               | `country`, `state`, `employee_range` ("51,500"), `revenue_range`, `tech_stack`, `category`, `sub_industry`, `language`, `business_model` | Every filter has a `negate_` twin. `sub_industry` is a second-level label, bare or `PARENT/SUB` (`ROOFING`, `CONSTRUCTION/ROOFING`).                                                                                                                                                                                                           |
| Near a place         | `lat`, `lon`, `radius` (`50km`, `30mi`; default 50km) or `bbox` (`min_lat,min_lon,max_lat,max_lon`)                                      | Radius and bbox are mutually exclusive.                                                                                                                                                                                                                                                                                                        |
